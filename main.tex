...
We mainly performed simulations by A Multi-Phase Transport (AMPT) model~\cite{Lin:2004en} (Version: 2.25t7cu StringMelting) for $K-\Lambda$ and $K-\Xi$, and Ultra-relativistic Quantum Molecular Dynamics (UrQMD)~\cite{Bass:1998ca} for $K-\Lambda$ only. 

There are one valence s quark in $\Lambda$ and two in $\Xi$
...
\begin{figure*}[!htb]
  ...
  \begin{subfigure}{0.24\hsize}
      ...
      \label{62_KpX_AMPT}
  \end{subfigure}
  \caption{AMPT calculations of $K-\Lambda$ (left) and $K-\Xi$ (right).}
  \label{FIG_39_AMPT}
\end{figure*}
